...
//var basket_add_close = basket_add_popup.querySelector(".modal-close");
...
//  }
//});
var basket_link = document.querySelector(".catalog");
...
//basket_add_close.addEventListener("click", function(evt){
//  evt.preventDefault();
//  basket_add_popup.classList.remove("modal-show");
//});
//document.addEventListener("keydown", function(evt){
//  if (evt.keyCode === 27) {
//    evt.preventDefault();
//    if (basket_add_popup.classList.contains("modal-show")){
//    basket_add_popup.classList.remove("modal-show");
//    }
//  }
//});
